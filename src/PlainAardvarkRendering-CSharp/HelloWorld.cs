...
namespace PlainAardvarkRendering
{
    class HelloWorld
    {
        public static void Run()
        {
            ...
            var vertices = new V3f[] { new(-1, -1, 0), new(1, -1, 0), new(1, 1, 0), new(-1, 1, 0) };
            var colors = new C4b[] { C4b.Green, C4b.Red, C4b.Blue, C4b.White };
            ...
            var scene =
                ...
                .WithEffects([Effects.VertexColor.Effect]);
            ...
            using var renderTask = app.Runtime.CompileRender(win.FramebufferSignature, scene);
